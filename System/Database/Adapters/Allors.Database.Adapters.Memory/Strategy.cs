...
namespace Allors.Database.Adapters.Memory
{
    ...
    public sealed class Strategy : IStrategy
    {
        ...
        public void SetUnitRole(IRoleType roleType, object unit)
        {
            ...
            switch (unit)
            {
                case null:
                    ...
                    break;
                default:
                    this.unitRoleByRoleType[roleType] = unit;
                    break;
            }
        }
        ...
        internal void SaveUnit(XmlWriter writer, IRoleType roleType)
        {
            ...
            writer.WriteAttributeString(Serialization.Association, this.ObjectId.ToString(CultureInfo.InvariantCulture));
        ...
        internal void SaveComposites(XmlWriter writer, IRoleType roleType)
        {
            ...
            foreach (var roleStrategy in roleStragies)
            {
                ...
                writer.WriteString(roleStrategy.ObjectId.ToString(CultureInfo.InvariantCulture));
                ++i;
            }
        ...
        internal void SaveComposite(XmlWriter writer, IRoleType roleType)
        {
            ...
            writer.WriteString(roleStragy.ObjectId.ToString(CultureInfo.InvariantCulture));
