...
namespace Allors.Database.Adapters.Npgsql
{
    ...
    internal sealed class InstanceOf : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            {
                statement.Append(alias + "." + ColumnNameForClass + "=" + statement.AddParameter(this.instanceClasses[0].Id) + " ");
            }
            else if (this.instanceClasses.Length > 1)
            {
                ...
                {
                    statement.Append(alias + "." + ColumnNameForClass + "=" + statement.AddParameter(this.instanceClasses[i].Id));
