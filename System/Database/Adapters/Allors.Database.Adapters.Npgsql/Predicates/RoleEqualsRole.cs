    ...
    internal sealed class RoleEqualsRole : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            if (this.role.ObjectType.IsUnit && this.equalsRole.ObjectType.IsUnit)
            {
                ...
                {
                    statement.Append(" " + alias + "." + mapping.ColumnNameByRelationType[this.role.RelationType] + $" {mapping.StringCollation} =" + alias + "." + mapping.ColumnNameByRelationType[this.equalsRole.RelationType] + $" {mapping.StringCollation}");
                }
                else
                {
                    statement.Append(" " + alias + "." + mapping.ColumnNameByRelationType[this.role.RelationType] + "=" + alias + "." + mapping.ColumnNameByRelationType[this.equalsRole.RelationType]);
                }
            }
