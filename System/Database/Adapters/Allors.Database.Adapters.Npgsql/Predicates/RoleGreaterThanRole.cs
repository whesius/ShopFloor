...
namespace Allors.Database.Adapters.Npgsql
{
    ...
    internal sealed class RoleGreaterThanRole : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            statement.Append(" " + alias + "." + mapping.ColumnNameByRelationType[this.role.RelationType] + ">" + alias + "." + mapping.ColumnNameByRelationType[this.greaterThanRole.RelationType]);
            return this.Include;
        }
