    ...
    public class Save
    {
        ...
        protected void SaveObjects(ManagementTransaction transaction)
        {
            ...
            foreach (var type in concreteCompositeType)
            {
                ...
                var sql = "SELECT " + ColumnNameForObject + ", " + ColumnNameForVersion + "\n";
                sql += "FROM " + this.database.Mapping.TableNameForObjects + "\n";
                sql += "WHERE " + ColumnNameForClass + "=" + mapping.ParamInvocationNameForClass + "\n";
                sql += "ORDER BY " + ColumnNameForObject;
                ...
                if (associationType.ObjectType.ExistDatabaseClass)
                {
                    ...
                    if (roleType.ObjectType.IsUnit)
                    {
                        ...
                        foreach (var exclusiveRootClass in exclusiveRootClasses)
                        {
                            ...
                            sql += "SELECT " + ColumnNameForObject + " As " + ColumnNameForAssociation + ", " + this.database.Mapping.ColumnNameByRelationType[roleType.RelationType] + " As " + ColumnNameForRole + "\n";
                    ...
                    else
                    {
                        ...
                        {
                            // role.Many
                            sql += "SELECT " + this.database.Mapping.ColumnNameByRelationType[associationType.RelationType] + " As " + ColumnNameForAssociation + ", " + ColumnNameForObject + " As " + ColumnNameForRole + "\n";
