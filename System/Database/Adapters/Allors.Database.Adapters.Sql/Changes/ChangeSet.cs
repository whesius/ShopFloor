...
namespace Allors.Database.Adapters.Sql
{
    ...
    public sealed class ChangeSet : IChangeSet
    {
        ...
        public ChangeSet(ISet<IObject> created, ISet<IStrategy> deleted, IDictionary<IObject, ISet<IRoleType>> roleTypesByAssociation, IDictionary<IObject, ISet<IAssociationType>> associationTypesByRole)
        {
