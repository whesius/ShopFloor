...
namespace Allors.Database.Adapters.SqlClient
{
    ...
    internal sealed class AssociationInstanceOf : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            {
                statement.Append(" (" + statement.GetJoinName(this.association) + "." + ColumnNameForClass + " IS NOT NULL AND ");
                statement.Append(" " + statement.GetJoinName(this.association) + "." + ColumnNameForClass + "=" + statement.AddParameter(this.instanceClasses[0].Id) + ") ");
            }
            else if (this.instanceClasses.Length > 1)
            {
                ...
                {
                    statement.Append(" (" + statement.GetJoinName(this.association) + "." + ColumnNameForClass + " IS NOT NULL AND ");
                    statement.Append(" " + statement.GetJoinName(this.association) + "." + ColumnNameForClass + "=" + statement.AddParameter(this.instanceClasses[i].Id) + ")");
