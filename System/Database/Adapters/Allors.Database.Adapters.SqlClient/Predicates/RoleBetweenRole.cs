...
namespace Allors.Database.Adapters.SqlClient
{
    ...
    internal sealed class RoleBetweenRole : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            statement.Append(" (" + alias + "." + mapping.ColumnNameByRelationType[this.role.RelationType] + " BETWEEN " + alias + "." + mapping.ColumnNameByRelationType[this.first.RelationType] + " AND " + alias + "." + mapping.ColumnNameByRelationType[this.second.RelationType] + ")");
            return this.Include;
        }
