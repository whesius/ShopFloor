...
namespace Allors.Database.Adapters.SqlClient
{
    ...
    internal sealed class RoleBetweenValue : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            statement.Append(" (" + alias + "." + mapping.ColumnNameByRelationType[this.roleType.RelationType] + " BETWEEN " + statement.AddParameter(this.first) + " AND " + statement.AddParameter(this.second) + ")");
            return this.Include;
        }
