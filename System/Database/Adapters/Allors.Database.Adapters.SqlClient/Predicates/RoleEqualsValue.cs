...
namespace Allors.Database.Adapters.SqlClient
{
    ...
    internal sealed class RoleEqualsValue : Predicate
    {
        ...
        internal override bool BuildWhere(ExtentStatement statement, string alias)
        {
            ...
            {
                statement.Append(" " + alias + "." + mapping.ColumnNameByRelationType[this.roleType.RelationType] + "=" + statement.AddParameter(this.obj));
            }
            else
            {
                ...
                {
                    statement.Append(" (" + alias + "." + mapping.ColumnNameByRelationType[this.roleType.RelationType] + " IS NOT NULL AND ");
                    statement.Append(" " + alias + "." + mapping.ColumnNameByRelationType[this.roleType.RelationType] + "=" + allorsObject.Strategy.ObjectId + ")");
                }
                else
                {
                    statement.Append(" (" + mapping.RoleJoinAlias(this.roleType) + "." + ColumnNameForRole + " IS NOT NULL AND ");
                    statement.Append(" " + mapping.RoleJoinAlias(this.roleType) + "." + ColumnNameForRole + "=" + allorsObject.Strategy.ObjectId + ")");
                }
            }
