                ...
                if (associationType.ObjectType.ExistDatabaseClass)
                {
                    ...
                    if (roleType.ObjectType.IsUnit)
                    {
                        ...
                        foreach (var exclusiveRootClass in exclusiveRootClasses)
                        {
                            ...
                            sql +=
                                $"SELECT {ColumnNameForObject} As {ColumnNameForAssociation}, {this.database.Mapping.ColumnNameByRelationType[roleType.RelationType]} As {ColumnNameForRole}\n";
                            sql +=
                    ...
                    else
                    {
                        ...
                        else
                        {
                            // role.Many
                            sql +=
                                $"SELECT {this.database.Mapping.ColumnNameByRelationType[associationType.RelationType]} As {ColumnNameForAssociation}, {ColumnNameForObject} As {ColumnNameForRole}\n";
                            sql +=
