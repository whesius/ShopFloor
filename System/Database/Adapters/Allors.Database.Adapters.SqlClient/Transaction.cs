...
namespace Allors.Database.Adapters.SqlClient
{
    ...
    public sealed class Transaction : ITransaction
    {
        ...
        public void Prefetch(PrefetchPolicy prefetchPolicy, IEnumerable<string> objectIds) => this.Prefetch(prefetchPolicy, objectIds.Select(long.Parse));
        ...
        public Extent<T> Extent<T>() where T : IObject => this.Extent((IComposite)this.Database.ObjectFactory.GetObjectType<T>());

        public Allors.Database.Extent Extent(IComposite objectType) => new ExtentFiltered(this, objectType);
        ...
        {
            var objectType = (IClass)this.Database.ObjectFactory.GetObjectType<T>();
