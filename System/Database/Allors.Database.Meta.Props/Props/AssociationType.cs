...
namespace Allors.Database.Meta.Configuration
{
    ...
    public abstract partial class AssociationType : IAssociationTypeBase, IComparable
    {
        ...
        public string SchemaName  => this.objectType.SchemaName + "_" + this.RoleType.SchemaName;

        private string DisplayName => this.Name;

        private string ValidationName => "association type " + this.Name;

        public override bool Equals(object obj) => this.relationType.Id.Equals((obj as AssociationType)?.relationType.Id);

        public override int GetHashCode() => this.relationType.Id.GetHashCode();

        public int CompareTo(object obj) => this.relationType.Id.CompareTo((obj as AssociationType)?.relationType.Id);
