...
namespace Allors.Database.Meta.Configuration
{
    ...
    public sealed partial class Inheritance : IInheritanceBase, IComparable
    {
        ...
        internal Inheritance(MetaPopulationBase metaPopulation)
        {
        ...
        public override bool Equals(object obj) => this.Subtype.Id.Equals((obj as Inheritance)?.Subtype.Id) && this.Supertype.Id.Equals((obj as Inheritance)?.Supertype.Id);
