...
namespace Allors.Database.Meta.Configuration
{
    ...
    public abstract partial class RoleType : IRoleTypeBase, IComparable
    {
        ...
        protected readonly IMetaPopulationBase metaPopulation;
        ...
        public override bool Equals(object obj) => this.RelationType.Id.Equals((obj as IRoleType)?.RelationType.Id);
        ...
        public int CompareTo(object obj) => this.RelationType.Id.CompareTo((obj as IRoleType)?.RelationType.Id);
