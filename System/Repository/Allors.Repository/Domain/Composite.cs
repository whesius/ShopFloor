...
namespace Allors.Repository.Domain
{
    ...
    public abstract class Composite : Type
    {
        ...
        public new abstract bool IsClass { get; }

        public new abstract bool IsInterface { get; }
        ...
        public string AssignedPluralName => !Pluralizer.Pluralize(this.SingularName).Equals(this.PluralName, StringComparison.Ordinal) ? this.PluralName : null;
        ...
        public string SchemaName
        {
            get
            {
                ...
                return attribute != null ? attribute.Value : this.SingularName;
            }
        }

        public string AssignedSchemaName => !this.SchemaName.Equals(this.SingularName, StringComparison.Ordinal) ? this.SchemaName : null;
        ...
        public Class[] Subclasses => this.Subtypes.OfType<Class>().ToArray();
