    ...
    public class Method
    {
        ...
        public string SchemaName
        {
            get
            {
                ...
                return attribute != null ? attribute.Value : this.Name;
            }
        }

        public string AssignedSchemaName => !this.SchemaName.Equals(this.Name, StringComparison.Ordinal) ? this.SchemaName : null;
