...
namespace Allors.Repository.Domain
{
    ...
    public class Property
    {
        ...
        public string AssignedRoleSingularName => !this.RoleSingularName.Equals(this.Type.SingularName, StringComparison.Ordinal) ? this.RoleSingularName : null;
        ...
        public string AssignedRolePluralName => !Pluralizer.Pluralize(this.RoleSingularName).Equals(this.RolePluralName, StringComparison.Ordinal) ? this.RolePluralName : null;

        public string RoleSchemaName
        {
            get
            {
                dynamic attribute = this.AttributeByName.Get("Schema");
                return attribute != null ? attribute.Value : this.RoleSingularName;
            }
        }

        public string AssignedRoleSchemaName => !this.RoleSchemaName.Equals(this.RoleSingularName, StringComparison.Ordinal) ? this.RoleSchemaName : null;
