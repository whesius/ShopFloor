...
namespace Allors.Repository.Generation
{
    ...
    public class AllorsDirectoryInfo
    {
        ...
        {
            if (this.DirectoryInfo.Root.FullName.Equals(baseDirectory.DirectoryInfo.Root.FullName, StringComparison.Ordinal))
            {
        ...
        {
            if (!this.DirectoryInfo.FullName.Equals(this.DirectoryInfo.Root.FullName, StringComparison.Ordinal) && !this.DirectoryInfo.FullName.Equals(root.DirectoryInfo.FullName, StringComparison.Ordinal))
            {
                ancestors.Add(this);
        ...
        {
            if (this.DirectoryInfo.FullName.Equals(ancestor.DirectoryInfo.FullName, StringComparison.Ordinal))
            {
                return true;
            }
